...
if len(sys.argv) < 4:
    raise ValueError("Please call this script with ADAPT_scoring.py [ADAPT baseline] [error words output] [error sentences output]")
...
extract_words_sents(ADAPT_base, words_out, sents_out)
